...
public class AsyncException extends RuntimeException implements BaseException {
    ...
    private static final long serialVersionUID = 4350691158214973578L;
    ...
    private AsyncException(ErrorCodeMessage errorCodeMessage,
    ...
    public AsyncException(ErrorCodeMessage errorCodeMessage) {
        this(errorCodeMessage, null, null, null, null, null);
    }

    public AsyncException(ErrorCodeMessage errorCodeMessage, String error_description) {
        this(errorCodeMessage, error_description, null, null, null, null);
    }

    public AsyncException(ErrorCodeMessage errorCodeMessage, String error_description, Integer lockTime) {
        this(errorCodeMessage, error_description, null, null, null, lockTime);
    }


    public AsyncException(ErrorCodeMessage errorCodeMessage, String error_description, Throwable cause) {
        this(errorCodeMessage, error_description, null, cause, null, null);
    }

    public AsyncException(ErrorCodeMessage errorCodeMessage, Throwable cause) {
        this(errorCodeMessage, null, null, cause, null, null);
    }

    public AsyncException(ErrorCodeMessage errorCodeMessage, String error_description, String state) {
        this(errorCodeMessage, error_description, state, null, null, null);
    }

    public AsyncException(ErrorCodeMessage errorCodeMessage, String error_description, String state, Throwable cause, String refNumber) {
