...
public class OauthException extends RuntimeException implements BaseException {
    ...
    public OauthException(ErrorCodeMessage errorCodeMessage,
    ...
    public OauthException(ErrorCodeMessage errorCodeMessage, String error_description) {
        this(errorCodeMessage, error_description, null, null, null, null);
    }

    public OauthException(ErrorCodeMessage errorCodeMessage, String error_description, Integer lockTime) {
        this(errorCodeMessage, error_description, null, null, null, lockTime);
    }


    public OauthException(ErrorCodeMessage errorCodeMessage, String error_description, Throwable cause) {
        this(errorCodeMessage, error_description, null, cause, null, null);
    }

    public OauthException(ErrorCodeMessage errorCodeMessage, Throwable cause) {
        this(errorCodeMessage, null, null, cause, null, null);
    }

    public OauthException(ErrorCodeMessage errorCodeMessage, String error_description, String state) {
        this(errorCodeMessage, error_description, state, null, null, null);
    }

    public OauthException(ErrorCodeMessage errorCodeMessage, String error_description, String state, Throwable cause, String refNumber) {
